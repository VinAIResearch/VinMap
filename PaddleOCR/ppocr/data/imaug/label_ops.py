...
class SATRNLabelEncode(BaseRecLabelEncode):
    ...
    def __init__(self, max_text_length, character_dict_path=None, use_space_char=False, lower=False, **kwargs):
        super(SATRNLabelEncode, self).__init__(max_text_length, character_dict_path, use_space_char)
        self.lower = lower
...
class VQATokenLabelEncode(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        from paddlenlp.transformers import LayoutLMTokenizer, LayoutLMv2Tokenizer, LayoutXLMTokenizer
