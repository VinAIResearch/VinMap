    ...
    def set_epoch_as_seed(self, seed, dataset_config):
        if self.mode == "train":
            try:
                ...
                dataset_config["transforms"][border_map_id]["MakeBorderMap"]["epoch"] = seed if seed is not None else 0
                dataset_config["transforms"][shrink_map_id]["MakeShrinkMap"]["epoch"] = seed if seed is not None else 0
