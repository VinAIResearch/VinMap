...
class LMDBDataSetTableMaster(LMDBDataSet):
    def load_hierarchical_lmdb_dataset(self, data_dir):
        ...
        lmdb_sets[dataset_idx] = {"dirpath": data_dir, "env": env, "txn": txn, "num_samples": num_samples}
        return lmdb_sets
    ...
    def get_lmdb_sample_info(self, txn, index):
        ...
        bbox_split = ","
        bboxes = [{"bbox": convert_bbox(bsl.strip().split(bbox_split)), "tokens": ["1", "2"]} for bsl in bbox_str_list]
