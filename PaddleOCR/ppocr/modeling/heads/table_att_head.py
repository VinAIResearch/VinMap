...
class SLAHead(nn.Layer):
    def __init__(
        ...
        self.structure_generator = nn.Sequential(
            nn.Linear(self.hidden_size, self.hidden_size, weight_attr=weight_attr1_2, bias_attr=bias_attr1_2),
            nn.Linear(hidden_size, out_channels, weight_attr=weight_attr, bias_attr=bias_attr),
        )
        # loc
        ...
        self.loc_generator = nn.Sequential(
            nn.Linear(self.hidden_size, self.hidden_size, weight_attr=weight_attr1, bias_attr=bias_attr1),
            nn.Linear(self.hidden_size, loc_reg_num, weight_attr=weight_attr2, bias_attr=bias_attr2),
            nn.Sigmoid(),
        )
