...
def apply_to_static(model, config, logger):
    ...
    specs = [InputSpec([None] + config["Global"]["d2s_train_image_shape"], dtype="float32")]
    ...
    if algo == "SVTR_LCNet":
        ...
        specs.append(
            [InputSpec([None, config["Global"]["max_text_length"]], dtype="int64"), InputSpec([None], dtype="int64")]
        )
