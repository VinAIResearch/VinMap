...
class MbConvBlock(nn.Layer):
    def __init__(self, block_args):
        ...
        self._depthwise_conv = nn.Conv2D(
            oup, oup, groups=oup, kernel_size=k, stride=s, padding="same", bias_attr=False
        )
...
class EfficientNetb3_PREN(nn.Layer):
    def __init__(self, in_channels):
        ...
        self._conv_stem = nn.Conv2D(in_channels, out_channels, 3, 2, padding="same", bias_attr=False)
