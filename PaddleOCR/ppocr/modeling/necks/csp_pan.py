...
class CSPPAN(nn.Layer):
    ...
    def forward(self, inputs):
        ...
        for idx in range(len(self.in_channels) - 1, 0, -1):
            ...
            upsample_feat = F.upsample(feat_heigh, size=paddle.shape(feat_low)[2:4], mode="nearest")
        ...
        for idx in range(len(self.in_channels) - 1):
            ...
            out = self.bottom_up_blocks[idx](paddle.concat([downsample_feat, feat_height], 1))
            outs.append(out)
