...
from ppocr.modeling.backbones.rec_svtrnet import Block, ConvBNLayer, ones_, trunc_normal_, zeros_
...
class EncoderWithFC(nn.Layer):
    def __init__(self, in_channels, hidden_size):
        ...
        self.fc = nn.Linear(
            in_channels, hidden_size, weight_attr=weight_attr, bias_attr=bias_attr, name="reduce_encoder_fea"
        )
