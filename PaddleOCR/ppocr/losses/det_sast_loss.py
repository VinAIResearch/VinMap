...
class SASTLoss(nn.Layer):
    ...
    def forward(self, predicts, labels):
        ...
        tvo_in_loss = 0.5 * abs_tvo_geo_diff * abs_tvo_geo_diff * tvo_sign + (abs_tvo_geo_diff - 0.5) * (
            1.0 - tvo_sign
        )
        ...
        tco_in_loss = 0.5 * abs_tco_geo_diff * abs_tco_geo_diff * tco_sign + (abs_tco_geo_diff - 0.5) * (
            1.0 - tco_sign
        )
