...
log_level = 'INFO'
load_from = 'work_dirs/maskrcnn_resnext101_DCN_160e_icdar_btc/epoch_150.pth'
resume_from = None
workflow = [('train', 1)]
    ...
    train=dict(
        ...
        datasets=[
            dict(
                type='IcdarDataset',
                ann_file=
                'AIC/uaic2022_training_data/annotations1/json/instances_training.json',
                img_prefix='AIC/uaic2022_training_data/images',
                pipeline=None)
        ],
        pipeline=[
            dict(
...
evaluation = dict(
    interval=160,
    metric='hmean-iou',
    save_best='0_hmean-iou_hmean',
    rule='greater')
work_dir = './work_dirs/maskrcnn_resnext101_DCN_160e_icdar_btc'
gpu_ids = [0]
