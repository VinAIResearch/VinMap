...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=700, # adjusting these affects GPU usage
    ...
    train=dict(
        ...
        datasets=[
            dict(
                type='IcdarDataset',
                ann_file=
                'Dataset/json_converted/instances_training.json',
    ...
    val=dict(
        ...
        datasets=[
            dict(
                type='IcdarDataset',
                ann_file=
                'Dataset/json_converted/instances_validation.json',
                img_prefix='Dataset/images',
                pipeline=None)
        ],
        pipeline=[
    ...
    test=dict(
        ...
        datasets=[
            dict(
                type='IcdarDataset',
                ann_file=
                'Dataset/json_converted/instances_testing.json',
                img_prefix='Dataset/images'),
        ],
        pipeline=[
            dict(
