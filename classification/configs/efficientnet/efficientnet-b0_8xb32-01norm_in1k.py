...
train_pipeline = [
    ...
    dict(type="RandomResizedCrop", size=224, efficientnet_style=True, interpolation="bicubic"),
...
test_pipeline = [
    dict(type="LoadImageFromFile"),
    dict(type="CenterCrop", crop_size=224, efficientnet_style=True, interpolation="bicubic"),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ImageToTensor", keys=["img"]),
