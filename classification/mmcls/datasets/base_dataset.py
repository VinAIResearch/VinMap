...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    def evaluate(self, results, metric="accuracy", metric_options=None, indices=None, logger=None):
        ...
        if len(set(metrics) & set(precision_recall_f1_keys)) != 0:
            if thrs is not None:
                ...
                precision_recall_f1_values = precision_recall_f1(results, gt_labels, average_mode=average_mode)
