...
class MNIST(BaseDataset):
    ...
    resources = {
        "train_image_file": ("train-images-idx3-ubyte.gz", "f68b3c2dcbeaaa9fbdd348bbdeb94873"),
        "train_label_file": ("train-labels-idx1-ubyte.gz", "d53e105ee54ea40749a09fcbcd1e9432"),
        "test_image_file": ("t10k-images-idx3-ubyte.gz", "9fb629c4189551a2d022fa330f9573f3"),
        "test_label_file": ("t10k-labels-idx1-ubyte.gz", "ec29112dd5afa0611ce80d1b7f02629c"),
    }
    ...
    def load_annotations(self):
        train_image_file = osp.join(self.data_prefix, rm_suffix(self.resources["train_image_file"][0]))
        train_label_file = osp.join(self.data_prefix, rm_suffix(self.resources["train_label_file"][0]))
        test_image_file = osp.join(self.data_prefix, rm_suffix(self.resources["test_image_file"][0]))
        test_label_file = osp.join(self.data_prefix, rm_suffix(self.resources["test_label_file"][0]))
    ...
    def download(self):
        ...
        for url, md5 in self.resources.values():
            ...
            download_and_extract_archive(url, download_root=self.data_prefix, filename=filename, md5=md5)
...
class FashionMNIST(MNIST):
    ...
    resources = {
        "train_image_file": ("train-images-idx3-ubyte.gz", "8d4fb7e6c68d591d4c3dfef9ec88bf0d"),
        "train_label_file": ("train-labels-idx1-ubyte.gz", "25c81989df183df01b3e8a0aad5dffbe"),
        "test_image_file": ("t10k-images-idx3-ubyte.gz", "bef4ecab320f06d8554ea6380940ec79"),
        "test_label_file": ("t10k-labels-idx1-ubyte.gz", "bb300cfdad3c16e7a12a480ee83cd310"),
    }
    CLASSES = [
        "T-shirt/top",
        "Trouser",
