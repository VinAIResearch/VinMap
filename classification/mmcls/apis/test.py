    ...
    for i, data in enumerate(data_loader):
        ...
        if show or out_dir:
            ...
            for i, (img, img_meta) in enumerate(zip(imgs, img_metas)):
                ...
                result_show = {"pred_score": pred_score[i], "pred_label": pred_label[i], "pred_class": pred_class[i]}
                model.module.show_result(img_show, result_show, show=show, out_file=out_file, **show_kwargs)
