...
from mmcv.cnn.bricks import Conv2dAdaptivePadding, build_activation_layer, build_norm_layer
...
class ConvMixer(BaseBackbone):
    ...
    arch_settings = {
        "768/32": {"embed_dims": 768, "depth": 32, "patch_size": 7, "kernel_size": 7},
        "1024/20": {"embed_dims": 1024, "depth": 20, "patch_size": 14, "kernel_size": 9},
        "1536/20": {"embed_dims": 1536, "depth": 20, "patch_size": 7, "kernel_size": 9},
    }
    ...
    def __init__(
        ...
        if isinstance(arch, str):
            ...
            essential_keys = {"embed_dims", "depth", "patch_size", "kernel_size"}
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(in_channels, self.embed_dims, kernel_size=self.patch_size, stride=self.patch_size),
            self.act,
