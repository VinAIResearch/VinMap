...
from mmcv.cnn.bricks import NORM_LAYERS, DropPath, build_activation_layer, build_norm_layer
    ...
    def __init__(
        ...
        if isinstance(arch, str):
            ...
            assert "depths" in arch and "channels" in arch, (
                f'The arch dict must have "depths" and "channels", ' f"but got {list(arch.keys())}."
            )
