...
def binary_cross_entropy(
    pred, label, weight=None, reduction="mean", avg_factor=None, class_weight=None, pos_weight=None
):
...
class CrossEntropyLoss(nn.Module):
    ...
    def __init__(
        self, use_sigmoid=False, use_soft=False, reduction="mean", loss_weight=1.0, class_weight=None, pos_weight=None
    ):
