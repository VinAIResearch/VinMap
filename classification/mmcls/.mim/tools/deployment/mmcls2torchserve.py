...
def parse_args():
    parser = ArgumentParser(description="Convert mmcls models to TorchServe `.mar` format.")
...
if __name__ == "__main__":
    ...
    mmcls2torchserve(args.config, args.checkpoint, args.output_folder, args.model_name, args.model_version, args.force)
