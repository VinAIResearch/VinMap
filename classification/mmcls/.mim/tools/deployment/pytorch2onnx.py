...
def pytorch2onnx(
    ...
    # Some backbones use `num_classes=-1` to disable top classifier.
        ...
        raise AttributeError('Cannot find "num_classes" in both head and ' "backbone, please check the config file.")
    ...
    if verify:
        ...
        if dynamic_export:
            dynamic_test_inputs = _demo_mm_inputs(
                (input_shape[0], input_shape[1], input_shape[2] * 2, input_shape[3] * 2), model.head.num_classes
            )
