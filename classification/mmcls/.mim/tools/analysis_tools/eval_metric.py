...
def main():
    ...
    assert "class_scores" in outputs, 'No "class_scores" in result file, please set "--out-items" in test.py'
    ...
    eval_kwargs.update(dict(metric=args.metrics, metric_options=args.metric_options))
