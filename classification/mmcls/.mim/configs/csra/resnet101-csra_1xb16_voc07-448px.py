...
checkpoint = (
    "https://download.openmmlab.com/mmclassification/v0/resnet/resnet101_8xb32_in1k_20210831-539c63f8.pth"  # noqa
)
...
# learning policy
lr_config = dict(
    policy="step", step=6, gamma=0.1, warmup="linear", warmup_iters=1, warmup_ratio=1e-7, warmup_by_epoch=True
)
