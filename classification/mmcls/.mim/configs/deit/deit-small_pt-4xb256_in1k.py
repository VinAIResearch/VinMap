...
model = dict(
    ...
    backbone=dict(type="VisionTransformer", arch="deit-small", img_size=224, patch_size=16),
    neck=None,
    head=dict(
...
paramwise_cfg = dict(
    norm_decay_mult=0.0,
    bias_decay_mult=0.0,
    custom_keys={".cls_token": dict(decay_mult=0.0), ".pos_embed": dict(decay_mult=0.0)},
)
