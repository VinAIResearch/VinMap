...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate training and validation set of TextOCR ")
...
def collect_textocr_info(root_path, annotation_filename, print_every=1000):
    ...
    for i, img_info in enumerate(annotation["imgs"].values()):
        ...
        for ann_id in ann_ids:
            ...
            anno = dict(iscrowd=iscrowd, category_id=1, bbox=bbox, area=ann["area"], segmentation=[segmentation])
