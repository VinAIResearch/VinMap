...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate training and val set of ReCTS.")
...
def main():
    ...
    with mmcv.Timer(print_tmpl="It takes {}s to convert ReCTS Training annotation"):
    ...
    if len(val_files) > 0:
        ...
        with mmcv.Timer(print_tmpl="It takes {}s to convert ReCTS Val annotation"):
