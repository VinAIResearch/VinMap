...
def process_img(args, dst_image_root, ignore_image_root, preserve_vertical, split, format):
...
def convert_lsvt(root_path, split, ratio, preserve_vertical, format, nproc, img_start_idx=0):
