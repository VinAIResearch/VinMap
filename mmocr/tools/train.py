...
from mmocr.utils import collect_env, get_root_logger, is_2dlist, setup_multi_processes
...
def parse_args(arg_list=None):
    ...
    parser.add_argument(
        "--launcher", choices=["none", "pytorch", "slurm", "mpi"], default="none", help="Options for job launcher."
    )
