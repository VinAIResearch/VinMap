...
html_theme_options = {
    "logo_url": "https://mmocr.readthedocs.io/zh_CN/latest",
    "menu": [
        {
            "name": "教程",
        ...
        {"name": "GitHub", "url": "https://github.com/open-mmlab/mmocr"},
        {
            "name": "上游库",
            "children": [
                {"name": "MMCV", "url": "https://github.com/open-mmlab/mmcv", "description": "基础视觉库"},
                {
                    "name": "MMDetection",
    ...
    "header_note": {
        "title": "注意",
        "content": "您正在阅读 MMOCR 0.x 版本的文档。MMOCR 0.x 会在 2022 年末开始"
