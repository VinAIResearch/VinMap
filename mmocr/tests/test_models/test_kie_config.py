...
@pytest.mark.parametrize(
    "cfg_file", ["kie/sdmgr/sdmgr_novisual_60e_wildreceipt.py", "kie/sdmgr/sdmgr_unet16_60e_wildreceipt.py"]
)
def test_sdmgr_pipeline(cfg_file):
    ...
    losses = detector.forward(
        imgs, img_metas, relations=relations, texts=texts, gt_bboxes=gt_bboxes, gt_labels=gt_labels
    )
