...
def test_invalid_polys():
    ...
    poly = np.array(
        [
            [256.1229216, 347.17471155],
            [257.63126133, 347.0069367],
    ...
    poly = np.array(
        [
            [570.34735492, 335.00214526],
            [570.99778839, 335.00327318],
    ...
    poly = np.array(
        [
            [481.18343777, 305.03190065],
            [479.88478587, 305.10684512],
            [479.90976971, 305.53968843],
            [480.99197962, 305.4772347],
        ]
    )
    assert dbtarget.invalid_polygon(poly)
