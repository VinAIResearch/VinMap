...
def test_replace_image_to_tensor(cfg_file):
    ...
    assert cfg1.data.test.pipeline[1]["transforms"][3]["type"] == "DefaultFormatBundle"
    assert cfg1.data.test.datasets[0].pipeline[1]["transforms"][3]["type"] == "DefaultFormatBundle"
    ...
    cfg2.data.test.pipeline = [cfg2.data.test.pipeline, cfg2.data.test.pipeline]
    cfg2 = replace_image_to_tensor(cfg2, set_types=["test"])
    assert cfg2.data.test.pipeline[0][1]["transforms"][3]["type"] == "DefaultFormatBundle"
    assert cfg2.data.test.datasets[0][0].pipeline[1]["transforms"][3]["type"] == "DefaultFormatBundle"
