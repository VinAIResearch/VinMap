...
def _create_dummy_icdar_json(json_name):
    ...
    fake_json = {
        ...
        "annotations": [annotation_1, annotation_2, annotation_3, annotation_4, annotation_5],
...
def test_icdar_dataset():
    ...
    assert np.allclose(
        ann["masks_ignore"], [[[150, 160, 190, 160, 190, 200, 150, 200]], [[250, 260, 350, 260, 350, 360, 250, 360]]]
    )
    ...
    results = [
        {"boundary_result": [[50, 60, 70, 60, 70, 80, 50, 80, 1], [100, 120, 130, 120, 120, 150, 100, 150, 1]]},
        {"boundary_result": []},
    ]
    ...
    results = [
        {"boundary_result": [[50, 60, 70, 60, 70, 80, 50, 80, 0.5], [100, 120, 130, 120, 120, 150, 100, 150, 1]]},
        {"boundary_result": []},
    ]
