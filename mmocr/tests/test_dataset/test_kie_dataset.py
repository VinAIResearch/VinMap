...
def _create_dummy_ann_file(ann_file):
    ann_info1 = {
        ...
        "width": 200,
        "annotations": [
            {"text": "store", "box": [11.0, 0.0, 22.0, 0.0, 12.0, 12.0, 0.0, 12.0], "label": 1},
            {"text": "address", "box": [23.0, 2.0, 31.0, 1.0, 24.0, 11.0, 16.0, 11.0], "label": 1},
            {"text": "price", "box": [33.0, 2.0, 43.0, 2.0, 36.0, 12.0, 25.0, 12.0], "label": 1},
            {"text": "1.0", "box": [46.0, 2.0, 61.0, 2.0, 53.0, 12.0, 39.0, 12.0], "label": 1},
            {"text": "google", "box": [61.0, 2.0, 69.0, 2.0, 63.0, 12.0, 55.0, 12.0], "label": 1},
        ],
    }
...
def _create_dummy_loader():
    loader = dict(
        type="HardDiskLoader",
        repeat=1,
        parser=dict(type="LineJsonParser", keys=["file_name", "height", "width", "annotations"]),
    )
    return loader
...
def test_kie_dataset():
    ...
    tmp_annos = [{"text": "store", "box": [11.0, 0.0, 22.0, 0.0, 12.0, 12.0, 0.0, 12.0]}]
