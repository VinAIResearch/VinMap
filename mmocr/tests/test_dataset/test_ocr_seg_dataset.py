...
def _create_dummy_ann_file(ann_file):
    ann_info1 = {
        ...
        "annotations": [
            {"char_text": "F", "char_box": [11.0, 0.0, 22.0, 0.0, 12.0, 12.0, 0.0, 12.0]},
            {"char_text": "r", "char_box": [23.0, 2.0, 31.0, 1.0, 24.0, 11.0, 16.0, 11.0]},
            {"char_text": "o", "char_box": [33.0, 2.0, 43.0, 2.0, 36.0, 12.0, 25.0, 12.0]},
            {"char_text": "m", "char_box": [46.0, 2.0, 61.0, 2.0, 53.0, 12.0, 39.0, 12.0]},
            {"char_text": ":", "char_box": [61.0, 2.0, 69.0, 2.0, 63.0, 12.0, 55.0, 12.0]},
        ],
        "text": "From:",
    }
    ann_info2 = {
        ...
        "annotations": [
            {"char_text": "o", "char_box": [0.0, 5.0, 7.0, 5.0, 9.0, 15.0, 2.0, 15.0]},
            {"char_text": "u", "char_box": [7.0, 4.0, 14.0, 4.0, 18.0, 18.0, 11.0, 18.0]},
            {"char_text": "t", "char_box": [13.0, 1.0, 19.0, 2.0, 24.0, 18.0, 17.0, 18.0]},
        ],
        "text": "out",
    }
...
def _create_dummy_loader():
    loader = dict(
        type="HardDiskLoader", repeat=1, parser=dict(type="LineJsonParser", keys=["file_name", "text", "annotations"])
    )
    return loader
...
def test_ocr_seg_dataset():
    ...
    expect_results = {"img_info": {"filename": "sample1.png"}, "img_prefix": "", "ann_info": return_anno}
