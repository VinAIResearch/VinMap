...
def _create_dummy_ann_file(ann_file):
    ann_info1 = {
        ...
        "width": 200,
        "annotations": [
            {"text": "store", "box": [11.0, 0.0, 22.0, 0.0, 12.0, 12.0, 0.0, 12.0], "label": 1, "edge": 1},
            {"text": "MyFamily", "box": [23.0, 2.0, 31.0, 1.0, 24.0, 11.0, 16.0, 11.0], "label": 2, "edge": 1},
        ],
    }
...
def test_openset_kie_dataset():
    with tempfile.TemporaryDirectory() as tmp_dir_name:
        ...
        result["nodes"] = torch.tensor([[0.01, 0.8, 0.01, 0.18], [0.01, 0.01, 0.9, 0.08]])
