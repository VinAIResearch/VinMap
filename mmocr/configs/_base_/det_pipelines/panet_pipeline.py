...
train_pipeline_ctw1500 = [
    ...
    dict(type="RandomCropInstances", target_size=target_size_train_ctw1500, instance_key="gt_kernels"),
...
train_pipeline_icdar2015 = [
    ...
    dict(type="RandomFlip", flip_ratio=0.5, direction="horizontal"),
    dict(type="RandomRotateTextDet"),
    dict(type="RandomCropInstances", target_size=target_size_train_icdar2015, instance_key="gt_kernels"),
    dict(type="Pad", size_divisor=32),
    dict(
        type="CustomFormatBundle",
        keys=["gt_kernels", "gt_mask"],
...
train_pipeline_icdar2017 = [
    ...
    dict(type="RandomFlip", flip_ratio=0.5, direction="horizontal"),
    dict(type="RandomRotateTextDet"),
    dict(type="RandomCropInstances", target_size=target_size_train_icdar2017, instance_key="gt_kernels"),
    dict(type="Pad", size_divisor=32),
    dict(
        type="CustomFormatBundle",
        keys=["gt_kernels", "gt_mask"],
