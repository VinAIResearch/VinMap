...
train_pipeline_icdar2015 = [
    ...
    dict(type="FCENetTargets", fourier_degree=5, level_proportion_range=leval_prop_range_icdar2015),
    dict(
...
train_pipeline_ctw1500 = [
    ...
    dict(type="RandomFlip", flip_ratio=0.5, direction="horizontal"),
    dict(type="Pad", size_divisor=32),
    dict(type="FCENetTargets", fourier_degree=5, level_proportion_range=leval_prop_range_ctw1500),
    dict(
        type="CustomFormatBundle",
        keys=["p3_maps", "p4_maps", "p5_maps"],
        visualize=dict(flag=False, boundary_key=None),
