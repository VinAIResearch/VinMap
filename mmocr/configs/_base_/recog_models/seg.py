label_convertor = dict(type="SegConvertor", dict_type="DICT36", with_unknown=True, lower=True)
...
model = dict(
    ...
    loss=dict(type="SegLoss", seg_downsample_ratio=1.0, seg_with_loss_weight=True),
