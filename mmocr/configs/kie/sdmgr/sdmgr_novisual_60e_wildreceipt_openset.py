...
model = dict(
    ...
    bbox_head=dict(type="SDMGRHead", visual_dim=16, num_chars=92, num_classes=4),
...
test_pipeline = [
    ...
    dict(
        ...
        meta_keys=("filename", "ori_filename", "ori_texts", "ori_bboxes", "img_norm_cfg", "ori_filename", "img_shape"),
    ),
]
