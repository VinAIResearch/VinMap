...
img_norm_cfg_r50dcnv2 = dict(mean=[122.67891434, 116.66876762, 104.00698793], std=[58.395, 57.12, 57.375], to_rgb=True)
train_pipeline_r50dcnv2 = [
    ...
    dict(type="Collect", keys=["img", "gt_shrink", "gt_shrink_mask", "gt_thr", "gt_thr_mask"]),
]
...
data = dict(
    ...
    train=dict(type="UniformConcatDataset", datasets=train_list, pipeline=train_pipeline_r50dcnv2),
    val=dict(type="UniformConcatDataset", datasets=test_list, pipeline=test_pipeline_4068_1024),
    test=dict(type="UniformConcatDataset", datasets=test_list, pipeline=test_pipeline_4068_1024),
)
