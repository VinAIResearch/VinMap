...
data = dict(
    ...
    train=dict(type="UniformConcatDataset", datasets=train_list, pipeline=train_pipeline_r18),
    val=dict(type="UniformConcatDataset", datasets=test_list, pipeline=test_pipeline_1333_736),
    test=dict(type="UniformConcatDataset", datasets=test_list, pipeline=test_pipeline_1333_736),
)
