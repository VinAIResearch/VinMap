...
class ResNet31OCR(BaseModule):
    ...
    def __init__(
        ...
        # conv 1 (Conv, Conv)
        self.conv1_1 = nn.Conv2d(base_channels, channels[0], kernel_size=3, stride=1, padding=1)
        ...
        if self.last_stage_pool:
            self.pool5 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, ceil_mode=True)  # 1/16
