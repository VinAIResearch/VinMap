...
from mmocr.models.builder import DETECTORS, build_backbone, build_head, build_neck
...
class SingleStageDetector(MMDET_SingleStageDetector):
    ...
    def __init__(
        self, backbone, neck=None, bbox_head=None, train_cfg=None, test_cfg=None, pretrained=None, init_cfg=None
    ):
