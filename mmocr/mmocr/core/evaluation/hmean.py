...
def eval_hmean(
    ...
    **kwargs,
    ...
    if score_thr:
        warnings.warn("score_thr is deprecated. Please use min_score_thr " "instead.")
    ...
    for result in results:
        ...
        valid_texts, valid_text_scores = filter_2dlist_result(texts, scores, min_score_thr)
    ...
    for metric in metrics:
        ...
        for thr in np.arange(min_score_thr, min(max_score_thr + step, 1.0), step):
